...
public class ImportStressLogTest {
    ...
    public void importLog() {
        ...
        try {
            String sourceJson = FileUtils.readFileToString(new File(url.getFile() + "/sample/stress/source-kafka.json"), "utf-8");
            String sinkJson = FileUtils.readFileToString(new File(url.getFile() + "/sample/stress/sink-clickhouse.json"), "utf-8");

            vo.setName("import-stress-log");
